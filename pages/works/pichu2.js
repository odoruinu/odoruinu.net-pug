        ...
        <Row>
          <Col sm={6}>
            ...
            <div className='work-description'>
              <ul>
                <li>
                  <a href='http://www.donpy.net/standard-entry/app-reiview/4303.html' target='_blank' rel='noopener noreferrer'>
                  Webアプリ版twitterクライアントの「pichu*pichu」が凄い。 | 覚醒する @CDiP
                  </a>
                </li>
                <li>
                  <a href='http://labs.laurahouse.net/articles/iphone/1115.html' target='_blank' rel='noopener noreferrer'>
